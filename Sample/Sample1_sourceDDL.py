...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.TEST_DEPARTMENT(DEPT_ID DECIMAL(9,0),
DEPT_CODE STRING,
DESCRIPTION STRING,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.TEST_USER(UCL_USER_ID DECIMAL(18,0),
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.TEST_SUMMARY(PERF_SMRY_TRAN_ID DECIMAL(20,0),
WHSE STRING,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.TEST_LOCATIONS(LOCATION_ID INT,
...
CREATE TABLE IF NOT EXISTS DELTA_TRAINING.CALENDAR(DAY_DT TIMESTAMP,
...
WEEK_DT TIMESTAMP,
EST_TIME_CONV_AMT DECIMAL(6,6),
EST_TIME_CONV_HRS TINYINT,
ES0_TIME_CONV_AMT DECIMAL(6,6),
ES0_TIME_CONV_HRS TINYINT,
CST_TIME_CONV_AMT DECIMAL(6,6),
CST_TIME_CONV_HRS TINYINT,
CS0_TIME_CONV_AMT DECIMAL(6,6),
CS0_TIME_CONV_HRS TINYINT,
MST_TIME_CONV_AMT DECIMAL(6,6),
MST_TIME_CONV_HRS TINYINT,
MS0_TIME_CONV_AMT DECIMAL(6,6),
MS0_TIME_CONV_HRS TINYINT,
PST_TIME_CONV_AMT DECIMAL(6,6),
