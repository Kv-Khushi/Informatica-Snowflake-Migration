...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_NUODATA_USER")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_NUODATA_USER", variablesTableName, mainWorkflowId)

# COMMAND ----------
# DBTITLE 1, Shortcut_to_NUODATA_TEST_USER_0 [Source Definition] 
...
df_0.createOrReplaceTempView("Shortcut_to_NUODATA_TEST_USER_0")

# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_NUODATA_TEST_USER_1 [Source Qualifier] 
...
FROM
  Shortcut_to_NUODATA_TEST_USER_0"""

df_1 = spark.sql(query_1)

df_1.createOrReplaceTempView("SQ_Shortcut_to_NUODATA_TEST_USER_1")

# COMMAND ----------
# DBTITLE 1, EXP_INT_CONVERSION_2_2 [Expression] 
...
query_2_1 = f"""SELECT
  ...
  Monotonically_Increasing_Id AS Monotonically_Increasing_Id
FROM
  SQ_Shortcut_to_NUODATA_TEST_USER_1"""

df_2_1 = spark.sql(query_2_1)

df_2_1.createOrReplaceTempView("EXP_INT_CONVERSION_2_1")

query_2_2 = f"""SELECT
  *,
  TO_INTEGER(DC_NBR) AS o_DC_NBR
FROM
  EXP_INT_CONVERSION_2_1"""

df_2_2 = spark.sql(query_2_2)

df_2_2.createOrReplaceTempView("EXP_INT_CONVERSION_2_2")

# COMMAND ----------
# DBTITLE 1, Shortcut_to_WM_UCL_USER1_3 [Source Definition] 
...
# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_NUODATA_USER_4 [Source Qualifier] 
...
df_4.createOrReplaceTempView("SQ_Shortcut_to_NUODATA_USER_4")
...
FROM
  ...
  INNER JOIN EXP_INT_CONVERSION_2_2 DETAIL ON MASTER.STORE_NBR = DETAIL.o_DC_NBR"""
...
# COMMAND ----------
# DBTITLE 1, JNR_WM_UCL_USER_8 [Joiner] 
...
FROM
  SQ_Shortcut_to_NUODATA_USER_4 MASTER
...
# COMMAND ----------
# DBTITLE 1, FIL_UNCHANGED_RECORDS_9 [Filter] 
...
# COMMAND ----------
# DBTITLE 1, EXP_UPD_VALIDATOR_10_2 [Expression] 
...
df_10_1.createOrReplaceTempView("EXP_UPD_VALIDATOR_10_1")
...
query_10_2 = f"""SELECT
  *,
  ...
  IFF(
    (
      ISNULL(i_USER_NAME1)
      AND ISNULL(i_LOCATION_ID1)
    ),
    1,
    2
  ) AS o_UPDATE_VALIDATOR
FROM
  EXP_UPD_VALIDATOR_10_1"""

df_10_2 = spark.sql(query_10_2)

df_10_2.createOrReplaceTempView("EXP_UPD_VALIDATOR_10_2")

# COMMAND ----------
# DBTITLE 1, UPD_INS_UPD_11 [Update Strategy] 
...
# COMMAND ----------
# DBTITLE 1, NUODATA_USER [Target Definition] 


spark.sql("""MERGE INTO NUODATA_USER AS TARGET
USING
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_NUODATA_USER")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_NUODATA_USER", mainWorkflowId, parentName)
