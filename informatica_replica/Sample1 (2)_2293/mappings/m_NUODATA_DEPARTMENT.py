...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_NUODATA_TEST_DEPARTMENT_0 [Source Definition] 
...
# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_NUODATA_TEST_DEPARTMENT_1 [Source Qualifier] 
...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_WM_E_DEPT1_3 [Source Definition] 
...
# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_NUODATA_DEPARTMENT_4 [Source Qualifier] 
...
df_4.createOrReplaceTempView("SQ_Shortcut_to_NUODATA_DEPARTMENT_4")
...
# COMMAND ----------
# DBTITLE 1, JNR_WM_E_DEPT_8 [Joiner] 
...
FROM
  SQ_Shortcut_to_NUODATA_DEPARTMENT_4 MASTER
...
# COMMAND ----------
# DBTITLE 1, NUODATA_DEPARTMENT [Target Definition] 


spark.sql("""MERGE INTO NUODATA_DEPARTMENT AS TARGET
USING
