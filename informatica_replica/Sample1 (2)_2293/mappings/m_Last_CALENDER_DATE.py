...
# COMMAND ----------
# DBTITLE 1, Shortcut_to_CALENDAR_0 [Source Definition] 
...
# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_CALENDAR_1 [Source Qualifier] 
...
# COMMAND ----------
# DBTITLE 1, EXP_LAST_RUN_DT_2_2 [Expression] 
...
df_2_1.createOrReplaceTempView("EXP_LAST_RUN_DT_2_1")
...
df_2_2.createOrReplaceTempView("EXP_LAST_RUN_DT_2_2")

if df_2_2.count() > 0 :
  Last_Run_Dt = df_2_2.agg({'SET_LAST_RUN_DT' : 'max'}).collect()[0][0]

# COMMAND ----------
# DBTITLE 1, FIL_FALSE_3 [Filter] 
...
# COMMAND ----------
# DBTITLE 1, TEST_COURT [Target Definition] 
