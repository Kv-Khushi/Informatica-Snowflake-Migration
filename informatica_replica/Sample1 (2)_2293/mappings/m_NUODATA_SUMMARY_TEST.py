...
updateVariable(preVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_NUODATA_SUMMARY_TEST")

# COMMAND ----------
fetchAndCreateVariables(parentName,"m_NUODATA_SUMMARY_TEST", variablesTableName, mainWorkflowId)

# COMMAND ----------
# DBTITLE 1, Shortcut_to_TEST_SUMMARY_0 [Source Definition] 
...
df_0.createOrReplaceTempView("Shortcut_to_TEST_SUMMARY_0")

# COMMAND ----------
# DBTITLE 1, SQ_Shortcut_to_TEST_SUMMARY_1 [Source Qualifier] 
...
FROM
  Shortcut_to_TEST_SUMMARY_0
WHERE
  {Initial_Load} (
    date_trunc(
      'DAY',
      Shortcut_to_TEST_SUMMARY_0.CREATE_DATE_TIME
    ) >= date_trunc(
      'DAY',
      to_date(
        DATE_FORMAT(
  ...
  OR (
    date_trunc('DAY', Shortcut_to_TEST_SUMMARY_0.MOD_DATE_TIME) >= date_trunc(
      'DAY',
      to_date(
        DATE_FORMAT(
          CAST('{Prev_Run_Dt}' AS timestamp),
...
df_1.createOrReplaceTempView("SQ_Shortcut_to_TEST_SUMMARY_1")
...
# COMMAND ----------
# DBTITLE 1, NUODATA_TEST_SUMMARY [Target Definition] 
...
updateVariable(postVariableAssignment, variablesTableName, mainWorkflowId, parentName, "m_NUODATA_SUMMARY_TEST")

# COMMAND ----------
#Update Mapping Variables in database.
persistVariables(variablesTableName, "m_NUODATA_SUMMARY_TEST", mainWorkflowId, parentName)
